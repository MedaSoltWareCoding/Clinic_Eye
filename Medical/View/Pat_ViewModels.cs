...
{
    public class Patient_ViewModel : INotifyPropertyChanged
    {
        public ObservableCollection<Patient> Patients { get; private set; }
        private readonly Data_pat databaseHelper;
        ...
        public Patient_ViewModel()
        {
            // Initialize the database helper with connection details
            databaseHelper = new Data_pat("localhost", "clinics", "root", "");
